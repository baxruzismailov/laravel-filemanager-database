...
var initPhotoSwipeFromDOM = function (gallerySelector) {
    ...
    var parseThumbnailElements = function (el) {
        ...
        for (var i = 0; i < numNodes; i++) {
            ...
            } else if ($(linkEl).data('type') == 'audio') {
                item = {
    ...
    var openPhotoSwipe = function (index, galleryElement, disableAnimation, fromURL) {
        ...
        gallery.listen('beforeChange', function () {
            ...
            $('.pswp__audio').removeClass('pswp-active-audio');

            currItem.find('.pswp__video').addClass('active');
            currItem.find('.pswp__audio').addClass('pswp-active-audio');
            ...
            $('.pswp__audio').each(function (index,el) {
                if (!$(this).hasClass('pswp-active-audio')) {
                    $('audio')[index].pause();
                    $(this).attr('src', $(this).attr('src'));
                }
            });
